<template>
  <footer class="w-full bg-[#00152e] text-white py-8 sm:py-12 md:py-16 font-sans border-t-4 border-[#E31E24]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
      ...
      <div class="flex flex-col space-y-6">
        <h3 class="text-lg sm:text-xl font-bold tracking-wide">Sign-up to receive our Newsletter</h3>
        <div class="flex w-full flex-col sm:flex-row">
          <input 
            type="email" 
            placeholder="Your Email here" 
            class="w-full bg-transparent border border-gray-500 px-3 sm:px-4 py-2 sm:py-3 focus:outline-none focus:border-white transition text-xs sm:text-sm"
          />
          <button class="bg-[#E31E24] hover:bg-red-700 px-3 sm:px-6 py-2 sm:py-3 font-bold flex items-center gap-2 uppercase text-xs sm:text-sm tracking-widest transition-all whitespace-nowrap">
            Send <span class="text-lg">➜</span>
          </button>
        </div>
        
        <div class="pt-6 sm:pt-8 opacity-80">
          <p class="text-[10px] sm:text-xs uppercase font-bold tracking-[0.2em] text-gray-400">Official Website of</p>
          <p class="text-base sm:text-lg font-black text-white leading-none">THE PAYNESVILLE CITY CHURCH</p>
          <p class="text-[10px] sm:text-xs text-red-500 font-bold mt-1 uppercase tracking-widest">Church of Pentecost</p>
        </div>
      </div>
